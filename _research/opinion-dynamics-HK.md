...
In order to address the diversity of the research area of opinion dynamics, I gave a general overview of different types of models within the applied area of opinion dynamics, combining different types of updating rules, interaction networks, deterministic and stochastic dynamics (e.g. the voter, DeGroot and Hegselmann-Krause (HK) model). 
